...
\begin{teorema}[Teorema fundamental de la teoría local de superficies] \label{teo:rig2}
...
\begin{teorema}[Teorema Egregium] \label{teo:egre}
...
\begin{teorema}[Rigidez de la esfera]
...
\begin{teorema}[Fórmula integral de Herglotz]\label{teo:herglotz}
...
\begin{teorema}[Rigidez de Cohn-Vossen] \label{teo:cohn}
...
%${ }$\\
%\section{Tres tipos de superficies rígidas}
%${ }$\\